...
PKG_LIB_FILE	= libtgdbm0.8.so
PKG_LIB_FILE8	= libtgdbm0.8.so
PKG_LIB_FILE9	= libtcl9tgdbm0.8.so
PKG_STUB_LIB_FILE = libtgdbmstub0.8.a
...
top_builddir	= /home/danilo/Public/tgdbm
...
test: binaries libraries
	cd tests; $(TCLSH) `echo $(srcdir)/all.tcl` $(TESTFLAGS) \
